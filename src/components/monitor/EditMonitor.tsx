  ...
  return (
    <div className='flex justify-center mt-10'>
        <div className='flex flex-col gap-5 max-w-[1040px] w-full p-5'>
            <div className='flex'>
                <h1 className='text-3xl text-white'>Update monitor</h1>
            </div>
            <div className='border border-slate-600 shadow-lg rounded p-5 '>
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        ...
                        />
                        <Button className="bg-[#9290C3] text-[#070F2B] hover:bg-[#535C91]" type="submit" disabled={submitting}>{!submitting ? "Update" : "Updating..."}</Button>
                    </form>
                </Form>
            </div>
        </div>
